...
import static net.sourceforge.jdistlib.math.Constants.DBL_EPSILON;
import static net.sourceforge.jdistlib.math.Constants.DBL_MIN;
import static net.sourceforge.jdistlib.math.Constants.DBL_MAX;
import net.sourceforge.jdistlib.Normal;
import net.sourceforge.jdistlib.math.IntegrationResult;
import net.sourceforge.jdistlib.math.UnivariateFunction;

// copy of jdistlib.math.Integrate with public accessible methods
public class Integrate {
     ...
     ***end prologue  dqagi
     */
//    public static final void dqagi(UnivariateFunction f, double bound, int inf,
...
//    } /* dqagi */
     ...
     */
    public static IntegrationResult dqagie(UnivariateFunction f, double bound, int inf, double epsabs, double epsrel, int limit) {
...
//			}
     ...
     ***end prologue  dqk15i
      ...
      uflow is the smallest positive magnitude.
     */
    public static double dqk15i(UnivariateFunction f, double boun, int inf, double a, double b,
     ...
     ***end prologue  dqpsrt
     */
    public static void dqpsrt(int limit, int last, int[] maxerr,
    ...
    ***end prologue  dqelg
    ...
    public static final double dqelg(int[] n, double[] epstab, double[] abserr, double[] res3la, int[] nres)
    {
	    /* Local variables */
